        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form action="{{ route('search') }}" method="GET" role="search"
                    class="d-none d-md-flex my-2 my-lg-0">
                    <div class="position-relative">
                        <input id="searchInput" name="q" type="search" class="form-control me-2"
                            placeholder="搜尋活動或公告" value="{{ request('q') }}" autocomplete="off" required
                            aria-label="搜尋" />
                        ...
                        <ul id="searchSuggestions" class="list-group"
                            ...
                            @foreach ($recentKeywords as $keyword)
                                <li class="list-group-item d-flex justify-content-between align-items-center search-suggestion-item"
                                    ...
                                    <span>{{ $keyword }}</span>
                                    <button type="button" class="remove-keyword-btn"
                                        data-keyword="{{ $keyword }}"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="adminDropdown">
                                    <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i
                                                class="bi bi-speedometer2 me-2"></i>儀表板</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="{{ route('admin.activities.index') }}"><i
                                                class="bi bi-calendar-check me-2"></i>活動管理</a></li>
                                    <li><a class="dropdown-item" href="{{ route('admin.comments.index') }}"><i
                                                class="bi bi-chat-dots me-2"></i>評論管理</a></li>
                                    <li><a class="dropdown-item" href="{{ route('admin.reports.index') }}"><i
                                                class="bi bi-flag me-2"></i>舉報管理</a></li>
                                    <li><a class="dropdown-item" href="{{ route('admin.announcements.index') }}"><i
                                                class="bi bi-megaphone me-2"></i>公告管理</a>
                                    </li>
                                    ...
                                    @if (auth()->user()->hasRole('super'))
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('admin.users.index') }}"><i
                                                    class="bi bi-people me-2"></i>用戶管理</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.roles.index') }}"><i
                                                    class="bi bi-person-badge me-2"></i>角色管理</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.permissions.index') }}"><i
                                                    class="bi bi-shield-lock me-2"></i>權限管理</a>
                                        </li>
                                        <li><a class="dropdown-item" href="{{ route('admin.settings.index') }}"><i
                                                    class="bi bi-sliders me-2"></i>系統設定</a>
                                        </li>
                                    @endif
                                </ul>
                            </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="{{ route('dashboard') }}"><i
                                            class="bi bi-columns-gap me-2"></i>我的儀表板</a></li>
                                <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i
                                            class="bi bi-person me-2"></i>個人資料</a></li>
                                <li><a class="dropdown-item" href="{{ route('member.activities') }}"><i
                                            class="bi bi-calendar me-2"></i>我的活動</a></li>
                                <li><a class="dropdown-item" href="{{ route('member.comments') }}"><i
                                            class="bi bi-chat-left-text me-2"></i>我的評論</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li>
                ...
                <!-- 搜尋欄 - 僅在移動裝置顯示 -->
                <form action="{{ route('search') }}" method="GET" role="search" class="d-md-none mt-3 w-100">
                    <div class="input-group">
                        <input id="searchInputMobile" name="q" type="search" class="form-control"
                            placeholder="搜尋活動或公告" value="{{ request('q') }}" required aria-label="搜尋" />
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ url('/') }}"
                                class="text-white text-decoration-none mb-2 d-inline-block">首頁</a></li>
                        <li><a href="{{ route('activities.index') }}"
                                class="text-white text-decoration-none mb-2 d-inline-block">活動</a></li>
                        <li><a href="{{ route('announcements.index') }}"
                                class="text-white text-decoration-none mb-2 d-inline-block">公告</a></li>
                    </ul>
                </div>
